...
static NSString *_coreJs =
@"dmFyIGdsb2JhbCA9IHRoaXMKCjsoZnVuY3Rpb24oKSB7CgogIHZhciBjYWxsYmFja3MgPSB7f"
@"QogIHZhciBjYWxsYmFja0lEID0gMAoKICB2YXIgX2Zvcm1hdE9DVG9KUyA9IGZ1bmN0aW9uK"
@"G9iaikgewogICAgaWYgKG9iaiA9PT0gdW5kZWZpbmVkIHx8IG9iaiA9PT0gbnVsbCkgcmV0d"
@"XJuIGZhbHNlCiAgICBpZiAodHlwZW9mIG9iaiA9PSAib2JqZWN0IikgewogICAgICBpZiAob"
@"2JqLl9fb2JqKSByZXR1cm4gb2JqCiAgICAgIGlmIChvYmouX19pc05pbCkgcmV0dXJuIGZhb"
@"HNlCiAgICB9CiAgICBpZiAob2JqIGluc3RhbmNlb2YgQXJyYXkpIHsKICAgICAgdmFyIHJld"
@"CA9IFtdCiAgICAgIG9iai5mb3JFYWNoKGZ1bmN0aW9uKG8pIHsKICAgICAgICByZXQucHVza"
@"ChfZm9ybWF0T0NUb0pTKG8pKQogICAgICB9KQogICAgICByZXR1cm4gcmV0CiAgICB9CiAgI"
@"CBpZiAob2JqIGluc3RhbmNlb2YgRnVuY3Rpb24pIHsKICAgICAgICByZXR1cm4gZnVuY3Rpb"
@"24oKSB7CiAgICAgICAgICAgIHZhciBhcmdzID0gQXJyYXkucHJvdG90eXBlLnNsaWNlLmNhb"
@"GwoYXJndW1lbnRzKQogICAgICAgICAgICB2YXIgZm9ybWF0ZWRBcmdzID0gX09DX2Zvcm1hd"
@"EpTVG9PQyhhcmdzKQogICAgICAgICAgICBmb3IgKHZhciBpID0gMDsgaSA8IGFyZ3MubGVuZ"
@"3RoOyBpKyspIHsKICAgICAgICAgICAgICAgIGlmIChhcmdzW2ldID09PSBudWxsIHx8IGFyZ"
@"3NbaV0gPT09IHVuZGVmaW5lZCB8fCBhcmdzW2ldID09PSBmYWxzZSkgewogICAgICAgICAgI"
@"CAgICAgZm9ybWF0ZWRBcmdzLnNwbGljZShpLCAxLCB1bmRlZmluZWQpCiAgICAgICAgICAgI"
@"H0gZWxzZSBpZiAoYXJnc1tpXSA9PSBuc251bGwpIHsKICAgICAgICAgICAgICAgIGZvcm1hd"
@"GVkQXJncy5zcGxpY2UoaSwgMSwgbnVsbCkKICAgICAgICAgICAgfQogICAgICAgIH0KICAgI"
@"CAgICByZXR1cm4gX09DX2Zvcm1hdE9DVG9KUyhvYmouYXBwbHkob2JqLCBmb3JtYXRlZEFyZ"
@"3MpKQogICAgICB9CiAgICB9CiAgICBpZiAob2JqIGluc3RhbmNlb2YgT2JqZWN0KSB7CiAgI"
@"CAgIHZhciByZXQgPSB7fQogICAgICBmb3IgKHZhciBrZXkgaW4gb2JqKSB7CiAgICAgICAgc"
@"mV0W2tleV0gPSBfZm9ybWF0T0NUb0pTKG9ialtrZXldKQogICAgICB9CiAgICAgIHJldHVyb"
@"iByZXQKICAgIH0KICAgIHJldHVybiBvYmoKICB9CiAgCiAgdmFyIF9tZXRob2RGdW5jID0gZ"
@"nVuY3Rpb24oaW5zdGFuY2UsIGNsc05hbWUsIG1ldGhvZE5hbWUsIGFyZ3MsIGlzU3VwZXIsI"
@"GlzUGVyZm9ybVNlbGVjdG9yKSB7CiAgICB2YXIgc2VsZWN0b3JOYW1lID0gbWV0aG9kTmFtZ"
@"QogICAgaWYgKCFpc1BlcmZvcm1TZWxlY3RvcikgewogICAgICBtZXRob2ROYW1lID0gbWV0a"
@"G9kTmFtZS5yZXBsYWNlKC9fXy9nLCAiLSIpCiAgICAgIHNlbGVjdG9yTmFtZSA9IG1ldGhvZ"
@"E5hbWUucmVwbGFjZSgvXy9nLCAiOiIpLnJlcGxhY2UoLy0vZywgIl8iKQogICAgICB2YXIgb"
@"WFyY2hBcnIgPSBzZWxlY3Rvck5hbWUubWF0Y2goLzovZykKICAgICAgdmFyIG51bU9mQXJnc"
@"yA9IG1hcmNoQXJyID8gbWFyY2hBcnIubGVuZ3RoIDogMAogICAgICBpZiAoYXJncy5sZW5nd"
@"GggPiBudW1PZkFyZ3MpIHsKICAgICAgICBzZWxlY3Rvck5hbWUgKz0gIjoiCiAgICAgIH0KI"
@"CAgIH0KICAgIHZhciByZXQgPSBpbnN0YW5jZSA/"
@"IF9PQ19jYWxsSShpbnN0YW5jZSwgc2VsZWN0b3JOYW1lLCBhcmdzLCBpc1N1cGVyKToKICAg"
@"ICAgICAgICAgICAgICAgICAgICAgIF9PQ19jYWxsQyhjbHNOYW1lLCBzZWxlY3Rvck5hbWUs"
@"IGFyZ3MpCiAgICByZXR1cm4gX2Zvcm1hdE9DVG9KUyhyZXQpCiAgfQoKICBPYmplY3QuZGVm"
@"aW5lUHJvcGVydHkoT2JqZWN0LnByb3RvdHlwZSwgIl9fYyIsIHt2YWx1ZTogZnVuY3Rpb24o"
@"bWV0aG9kTmFtZSkgewogICAgaWYgKHRoaXMgaW5zdGFuY2VvZiBCb29sZWFuKSB7CiAgICAg"
@"IHJldHVybiBmdW5jdGlvbigpIHsKICAgICAgICByZXR1cm4gZmFsc2UKICAgICAgfQogICAg"
@"fQogICAgCiAgICBpZiAoIXRoaXMuX19vYmogJiYgIXRoaXMuX19jbHNOYW1lKSB7CiAgICAg"
@"IGlmICghdGhpc1ttZXRob2ROYW1lXSkgewogICAgICAgIHRocm93IG5ldyBFcnJvcih0aGlz"
@"ICsgJy4nICsgbWV0aG9kTmFtZSArICcgaXMgdW5kZWZpbmVkJykKICAgICAgfQogICAgICBy"
@"ZXR1cm4gdGhpc1ttZXRob2ROYW1lXS5iaW5kKHRoaXMpOwogICAgfQoKICAgIHZhciBzZWxm"
@"ID0gdGhpcwogICAgaWYgKG1ldGhvZE5hbWUgPT0gJ3N1cGVyJykgewogICAgICByZXR1cm4g"
@"ZnVuY3Rpb24oKSB7CiAgICAgICAgaWYgKHNlbGYuX19vYmopIHsKICAgICAgICAgIHNlbGYu"
@"X19vYmouX19jbHNEZWNsYXJhdGlvbiA9IHNlbGYuX19jbHNEZWNsYXJhdGlvbjsKICAgICAg"
@"ICB9CiAgICAgICAgcmV0dXJuIHtfX29iajogc2VsZi5fX29iaiwgX19jbHNOYW1lOiBzZWxm"
@"Ll9fY2xzTmFtZSwgX19pc1N1cGVyOiAxfQogICAgICB9CiAgICB9CgogICAgaWYgKG1ldGhv"
@"ZE5hbWUuaW5kZXhPZigncGVyZm9ybVNlbGVjdG9yJykgPiAtMSkgewogICAgICBpZiAobWV0"
@"aG9kTmFtZSA9PSAncGVyZm9ybVNlbGVjdG9yJykgewogICAgICAgIHJldHVybiBmdW5jdGlv"
@"bigpewogICAgICAgICAgdmFyIGFyZ3MgPSBBcnJheS5wcm90b3R5cGUuc2xpY2UuY2FsbChh"
@"cmd1bWVudHMpCiAgICAgICAgICByZXR1cm4gX21ldGhvZEZ1bmMoc2VsZi5fX29iaiwgc2Vs"
@"Zi5fX2Nsc05hbWUsIGFyZ3NbMF0sIGFyZ3Muc3BsaWNlKDEpLCBzZWxmLl9faXNTdXBlciwg"
@"dHJ1ZSkKICAgICAgICB9CiAgICAgIH0gZWxzZSBpZiAobWV0aG9kTmFtZSA9PSAncGVyZm9y"
@"bVNlbGVjdG9ySW5PQycpIHsKICAgICAgICByZXR1cm4gZnVuY3Rpb24oKXsKICAgICAgICAg"
@"IHZhciBhcmdzID0gQXJyYXkucHJvdG90eXBlLnNsaWNlLmNhbGwoYXJndW1lbnRzKQogICAg"
@"ICAgICAgcmV0dXJuIHtfX2lzUGVyZm9ybUluT0M6MSwgb2JqOnNlbGYuX19vYmosIGNsc05h"
@"bWU6c2VsZi5fX2Nsc05hbWUsIHNlbDogYXJnc1swXSwgYXJnczogYXJnc1sxXSwgY2I6IGFy"
@"Z3NbMl19CiAgICAgICAgfQogICAgICB9CiAgICB9CiAgICByZXR1cm4gZnVuY3Rpb24oKXsK"
@"ICAgICAgdmFyIGFyZ3MgPSBBcnJheS5wcm90b3R5cGUuc2xpY2UuY2FsbChhcmd1bWVudHMp"
@"CiAgICAgIHJldHVybiBfbWV0aG9kRnVuYyhzZWxmLl9fb2JqLCBzZWxmLl9fY2xzTmFtZSwg"
@"bWV0aG9kTmFtZSwgYXJncywgc2VsZi5fX2lzU3VwZXIpCiAgICB9CiAgfSwgY29uZmlndXJh"
@"YmxlOmZhbHNlLCBlbnVtZXJhYmxlOiBmYWxzZX0pCgogIHZhciBfcmVxdWlyZSA9IGZ1bmN0"
@"aW9uKGNsc05hbWUpIHsKICAgIGlmICghZ2xvYmFsW2Nsc05hbWVdKSB7CiAgICAgIGdsb2Jh"
@"bFtjbHNOYW1lXSA9IHsKICAgICAgICBfX2Nsc05hbWU6IGNsc05hbWUKICAgICAgfQogICAg"
@"fSAKICAgIHJldHVybiBnbG9iYWxbY2xzTmFtZV0KICB9CgogIGdsb2JhbC5yZXF1aXJlID0g"
@"ZnVuY3Rpb24oY2xzTmFtZXMpIHsKICAgIHZhciBsYXN0UmVxdWlyZQogICAgY2xzTmFtZXMu"
@"c3BsaXQoJywnKS5mb3JFYWNoKGZ1bmN0aW9uKGNsc05hbWUpIHsKICAgICAgbGFzdFJlcXVp"
@"cmUgPSBfcmVxdWlyZShjbHNOYW1lLnRyaW0oKSkKICAgIH0pCiAgICByZXR1cm4gbGFzdFJl"
@"cXVpcmUKICB9CgogIHZhciBfZm9ybWF0RGVmaW5lTWV0aG9kcyA9IGZ1bmN0aW9uKG1ldGhv"
@"ZHMsIG5ld01ldGhvZHMsIGRlY2xhcmF0aW9uKSB7CiAgICBmb3IgKHZhciBtZXRob2ROYW1l"
@"IGluIG1ldGhvZHMpIHsKICAgICAgKGZ1bmN0aW9uKCl7CiAgICAgICB2YXIgb3JpZ2luTWV0"
@"aG9kID0gbWV0aG9kc1ttZXRob2ROYW1lXQogICAgICAgIG5ld01ldGhvZHNbbWV0aG9kTmFt"
@"ZV0gPSBbb3JpZ2luTWV0aG9kLmxlbmd0aCwgZnVuY3Rpb24oKSB7CiAgICAgICAgICB2YXIg"
@"YXJncyA9IF9mb3JtYXRPQ1RvSlMoQXJyYXkucHJvdG90eXBlLnNsaWNlLmNhbGwoYXJndW1l"
@"bnRzKSkKICAgICAgICAgIHZhciBsYXN0U2VsZiA9IGdsb2JhbC5zZWxmCiAgICAgICAgICB2"
@"YXIgcmV0OwogICAgICAgICAgdHJ5IHsKICAgICAgICAgICAgZ2xvYmFsLnNlbGYgPSBhcmdz"
@"WzBdCiAgICAgICAgICAgIGlmIChnbG9iYWwuc2VsZikgewogICAgICAgICAgICAgIGdsb2Jh"
@"bC5zZWxmLl9fY2xzRGVjbGFyYXRpb24gPSBkZWNsYXJhdGlvbgogICAgICAgICAgICB9CiAg"
@"ICAgICAgICAgIGFyZ3Muc3BsaWNlKDAsMSkKICAgICAgICAgICAgcmV0ID0gb3JpZ2luTWV0"
@"aG9kLmFwcGx5KG9yaWdpbk1ldGhvZCwgYXJncykKICAgICAgICAgICAgZ2xvYmFsLnNlbGYg"
@"PSBsYXN0U2VsZgogICAgICAgICAgfSBjYXRjaChlKSB7CiAgICAgICAgICAgIF9PQ19jYXRj"
@"aChlLm1lc3NhZ2UsIGUuc3RhY2spCiAgICAgICAgICB9CiAgICAgICAgICByZXR1cm4gcmV0"
@"CiAgICAgICAgfV0KICAgICAgfSkoKQogICAgfQogIH0KCiAgZ2xvYmFsLmRlZmluZUNsYXNz"
@"ID0gZnVuY3Rpb24oZGVjbGFyYXRpb24sIGluc3RNZXRob2RzLCBjbHNNZXRob2RzKSB7CiAg"
@"ICB2YXIgbmV3SW5zdE1ldGhvZHMgPSB7fSwgbmV3Q2xzTWV0aG9kcyA9IHt9CiAgICBfZm9y"
@"bWF0RGVmaW5lTWV0aG9kcyhpbnN0TWV0aG9kcywgbmV3SW5zdE1ldGhvZHMsZGVjbGFyYXRp"
@"b24pCiAgICBfZm9ybWF0RGVmaW5lTWV0aG9kcyhjbHNNZXRob2RzLCBuZXdDbHNNZXRob2Rz"
@"LGRlY2xhcmF0aW9uKQoKICAgIHZhciByZXQgPSBfT0NfZGVmaW5lQ2xhc3MoZGVjbGFyYXRp"
@"b24sIG5ld0luc3RNZXRob2RzLCBuZXdDbHNNZXRob2RzKQoKICAgIHJldHVybiByZXF1aXJl"
@"KHJldFsiY2xzIl0pCiAgfQoKICBnbG9iYWwuZGVmaW5lUHJvdG9jb2wgPSBmdW5jdGlvbihk"
@"ZWNsYXJhdGlvbiwgaW5zdFByb3RvcyAsIGNsc1Byb3RvcykgewogICAgICB2YXIgcmV0ID0g"
@"X09DX2RlZmluZVByb3RvY29sKGRlY2xhcmF0aW9uLCBpbnN0UHJvdG9zLGNsc1Byb3Rvcyk7"
@"CiAgICAgIHJldHVybiByZXQKICB9CgogIGdsb2JhbC5ibG9jayA9IGZ1bmN0aW9uKGFyZ3Ms"
@"IGNiKSB7CiAgICB2YXIgc2xmID0gdGhpcwogICAgaWYgKGFyZ3MgaW5zdGFuY2VvZiBGdW5j"
@"dGlvbikgewogICAgICBjYiA9IGFyZ3MKICAgICAgYXJncyA9ICcnCiAgICB9CiAgICB2YXIg"
@"Y2FsbGJhY2sgPSBmdW5jdGlvbigpIHsKICAgICAgdmFyIGFyZ3MgPSBBcnJheS5wcm90b3R5"
@"cGUuc2xpY2UuY2FsbChhcmd1bWVudHMpCiAgICAgIHJldHVybiBjYi5hcHBseShzbGYsIF9m"
@"b3JtYXRPQ1RvSlMoYXJncykpCiAgICB9CiAgICByZXR1cm4ge2FyZ3M6IGFyZ3MsIGNiOiBj"
@"YWxsYmFjaywgX19pc0Jsb2NrOiAxfQogIH0KICAKICBpZiAoZ2xvYmFsLmNvbnNvbGUpIHsK"
@"ICAgIHZhciBqc0xvZ2dlciA9IGNvbnNvbGUubG9nOwogICAgZ2xvYmFsLmNvbnNvbGUubG9n"
@"ID0gZnVuY3Rpb24oKSB7CiAgICAgIGdsb2JhbC5fT0NfbG9nLmFwcGx5KGdsb2JhbCwgYXJn"
@"dW1lbnRzKTsKICAgICAgaWYgKGpzTG9nZ2VyKSB7CiAgICAgICAganNMb2dnZXIuYXBwbHko"
@"Z2xvYmFsLmNvbnNvbGUsIGFyZ3VtZW50cyk7CiAgICAgIH0KICAgIH0KICB9IGVsc2Ugewog"
@"ICAgZ2xvYmFsLmNvbnNvbGUgPSB7CiAgICAgIGxvZzogZ2xvYmFsLl9PQ19sb2cKICAgIH0K"
@"ICB9CiAgCiAgZ2xvYmFsLllFUyA9IDEKICBnbG9iYWwuTk8gPSAwCiAgZ2xvYmFsLm5zbnVs"
@"bCA9IF9PQ19udWxsCiAgZ2xvYmFsLl9mb3JtYXRPQ1RvSlMgPSBfZm9ybWF0T0NUb0pTCiAg"
@"Cn0pKCk=";

@implementation STJPEngine
...
+ (void)startEngine {
    ...
    context[@"_OC_defineClass"] =
    ^(NSString *classDeclaration, JSValue *instanceMethods,
      JSValue *classMethods) {
        return defineClass(classDeclaration, instanceMethods, classMethods);
    };
    
    context[@"_OC_defineProtocol"] =
    ^(NSString *protocolDeclaration, JSValue *instProtocol,
      JSValue *clsProtocol) {
    ...
    context[@"_OC_callC"] =
    ^id(NSString *className, NSString *selectorName, JSValue *arguments) {
    ...
    context[@"__weak"] = ^id(JSValue *jsval) {
        ...
        return [[JSContext currentContext][@"_formatOCToJS"]
                callWithArguments:@[ formatOCToJS([STJPBoxing boxWeakObj:obj]) ]];
    };
    
    context[@"__strong"] = ^id(JSValue *jsval) {
        id obj = formatJSToOC(jsval);
        return [[JSContext currentContext][@"_formatOCToJS"]
                callWithArguments:@[ formatOCToJS(obj) ]];
    };
    ...
    context[@"dispatch_after"] = ^(double time, JSValue *func) {
        ...
        dispatch_after(
                       ...
                       dispatch_get_main_queue(), ^{
                           ...
                           weakCtx[@"self"] = formatOCToJS([STJPBoxing boxWeakObj:currSelf]);
    ...
    context[@"releaseTmpObj"] = ^void(JSValue *jsVal) {
        if ([[jsVal toObject] isKindOfClass:[NSDictionary class]]) {
            void *pointer = [(STJPBoxing *)([jsVal toObject][@"__obj"])unboxPointer];
            id obj = *((__unsafe_unretained id *)pointer);
            @synchronized(_TMPMemoryPool) {
                [_TMPMemoryPool
                 removeObjectForKey:[NSNumber
                                     numberWithInteger:[(NSObject *)obj hash]]];
            }
        }
    };
    ...
    NSString *jsCore = [[NSString alloc]
                        initWithData:[[NSData alloc] initWithBase64EncodedString:_coreJs
                                                                         options:0]
...
+ (JSValue *)evaluateScriptWithPath:(NSString *)filePath {
    ...
    NSString *script = [NSString stringWithContentsOfFile:filePath
                                                 encoding:NSUTF8StringEncoding
                                                    error:nil];
    return
    [self evaluateScript:script withSourceURL:[NSURL URLWithString:fileName]];
}

+ (JSValue *)evaluateScript:(NSString *)script
              withSourceURL:(NSURL *)resourceURL {
    ...
    NSString *formatedScript = [NSString
                                stringWithFormat:@"try{%@}catch(e){_OC_catch(e.message, e.stack)}",
                                [_regex stringByReplacingMatchesInString:
                                 script options:0 range:NSMakeRange(
                                                                    0, script.length)
...
+ (void)addExtensions:(NSArray *)extensions {
    ...
    NSAssert(_context, @"please call [STJPEngine startEngine]");
...
static void defineProtocol(NSString *protocolDeclaration, JSValue *instProtocol,
                           JSValue *clsProtocol) {
...
static void addGroupMethodsToProtocol(Protocol *protocol, JSValue *groupMethods,
                                      BOOL isInstance) {
    ...
    for (NSString *jpSelector in groupDic.allKeys) {
        ...
        methodDict[@"returnType"] && [methodDict[@"returnType"] length] > 0
        ? methodDict[@"returnType"]
        : @"void";
...
[_protocolTypeEncodeDict                                     \
setObject:[NSString stringWithUTF8String:@encode(_type)] \
forKey:@ #_type];
            ...
            if (returnEncode.length > 0) {
                ...
                for (NSInteger i = 0; i < argStrArr.count; i++) {
                    ...
                    if (!argEncode) {
                        NSString *argClassName =
                        trim([argStr stringByReplacingOccurrencesOfString:@"*"
                                                               withString:@""]);
...
static void addMethodToProtocol(Protocol *protocol, NSString *selectorName,
                                NSString *typeencoding, BOOL isInstance) {
...
static NSDictionary *defineClass(NSString *classDeclaration,
    ...
    NSArray *protocols =
    [declarationDict[@"protocolNames"] length]
    ? [declarationDict[@"protocolNames"] componentsSeparatedByString:@","]
    : nil;
...
static void JPForwardInvocation(__unsafe_unretained id assignSlf, SEL selector,
    ...
    NSString *JPSelectorName = [NSString stringWithFormat:@"_ST%@", selectorName];
    ...
    if ([slf class] == slf) {
        [argList addObject:[JSValue valueWithObject:@{
                                                      @"__clsName" : NSStringFromClass([slf class])
                                                      } inContext:_context]];
    } else if ([selectorName isEqualToString:@"dealloc"]) {
        [argList addObject:[STJPBoxing boxAssignObj:slf]];
        deallocFlag = YES;
    } else {
        [argList addObject:[STJPBoxing boxWeakObj:slf]];
    }
...
break;                                   \
            ...
            case '{': {
                NSString *typeString =
                extractStructName([NSString stringWithUTF8String:argumentType]);
...
break;                                                           \
                ...
                @synchronized(_context) {
                    ...
                    if (structDefine) {
                        ...
                        if (size) {
                            ...
                            [argList
                             addObject:[JSValue valueWithObject:dict inContext:_context]];
                            free(ret);
                            break;
                        }
                    }
            ...
            case '*': {
                void *arg;
                [invocation getArgument:&arg atIndex:i];
                [argList addObject:[STJPBoxing boxPointer:arg]];
                break;
            }
            case '#': {
                Class arg;
                [invocation getArgument:&arg atIndex:i];
                [argList addObject:[STJPBoxing boxClass:arg]];
                break;
            }
            default: {
...
case _typeChar: {                                     \
JP_FWD_RET_CALL_JS                                  \
_retCode [invocation setReturnValue:&ret];          \
break;                                              \
}
            
#define JP_FWD_RET_CASE(_typeChar, _type, _typeSelector) \
JP_FWD_RET_CASE_RET(_typeChar, _type,                  \
_type ret = [[jsval toObject] _typeSelector];)
            
#define JP_FWD_RET_CODE_ID                                    \
id __autoreleasing ret = formatJSToOC(jsval);               \
if (ret == _nilObj ||                                       \
([ret isKindOfClass:[NSNumber class]] &&                \
strcmp([ret objCType], "c") == 0 && ![ret boolValue])) \
ret = nil;
            
#define JP_FWD_RET_CODE_POINTER                 \
void *ret;                                    \
id obj = formatJSToOC(jsval);                 \
if ([obj isKindOfClass:[STJPBoxing class]]) { \
ret = [((STJPBoxing *)obj)unboxPointer];    \
}
...
ret = NSSelectorFromString(obj);          \
        ...
        case '{': {
            NSString *typeString =
            extractStructName([NSString stringWithUTF8String:returnType]);
...
break;                                                          \
    ...
    if (deallocFlag) {
        ...
        Method deallocMethod = class_getInstanceMethod(
                                                       instClass, NSSelectorFromString(@"ORIGdealloc"));
        void (*originalDealloc)(__unsafe_unretained id, SEL) =
        (__typeof__(originalDealloc))method_getImplementation(deallocMethod);
        originalDealloc(assignSlf, NSSelectorFromString(@"dealloc"));
    }
}

static void JPExcuteORIGForwardInvocation(id slf, SEL selector,
                                          NSInvocation *invocation) {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wundeclared-selector"
...
#pragma clang diagnostic pop
    ...
    if ([slf respondsToSelector:origForwardSelector]) {
        ...
        [slf methodSignatureForSelector:origForwardSelector];
        if (!methodSignature) {
            NSCAssert(
                      methodSignature,
                      @"unrecognized selector -ORIGforwardInvocation: for instance %@",
                      slf);
            return;
        }
        NSInvocation *forwardInv =
        ...
        if (![slf respondsToSelector:superForwardSelector]) {
            ...
            class_getInstanceMethod(superCls, @selector(forwardInvocation:));
            IMP superForwardIMP = method_getImplementation(superForwardMethod);
            class_addMethod([slf class], superForwardSelector, superForwardIMP,
                            method_getTypeEncoding(superForwardMethod));
        }
        
        NSMethodSignature *methodSignature =
        [slf methodSignatureForSelector:@selector(forwardInvocation:)];
        NSInvocation *forwardInv =
        [NSInvocation invocationWithMethodSignature:methodSignature];
        [forwardInv setTarget:slf];
...
static void overrideMethod(Class cls, NSString *selectorName, JSValue *function,
    ...
    IMP originalImp = class_respondsToSelector(cls, selector)
    ...
    if (typeDescription[0] == '{') {
        ...
        // NSMethodSignature knows the detail but has no API to return, we can only
        // get the info from debugDescription.
        NSMethodSignature *methodSignature =
        [NSMethodSignature signatureWithObjCTypes:typeDescription];
        if ([methodSignature.debugDescription
             rangeOfString:@"is special struct return? YES"].location !=
            NSNotFound) {
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wundeclared-selector"
    if (class_getMethodImplementation(cls, @selector(forwardInvocation:)) !=
        (IMP)JPForwardInvocation) {
        IMP originalForwardImp = class_replaceMethod(
                                                     cls, @selector(forwardInvocation:), (IMP)JPForwardInvocation, "v@:@");
        class_addMethod(cls, @selector(ORIGforwardInvocation:), originalForwardImp,
                        "v@:@");
    }
#pragma clang diagnostic pop
    ...
    if (class_respondsToSelector(cls, selector)) {
        ...
        [NSString stringWithFormat:@"ORIG%@", selectorName];
...
static id callSelector(NSString *className, NSString *selectorName,
                       JSValue *arguments, JSValue *instance, BOOL isSuper) {
    NSString *clsDeclaration =
    [[instance valueForProperty:@"__clsDeclaration"] toString];
    ...
    if (instance && [selectorName isEqualToString:@"toJS"]) {
        if ([instance isKindOfClass:[NSString class]] ||
            ...
            [instance isKindOfClass:[NSArray class]] ||
            [instance isKindOfClass:[NSDate class]]) {
    ...
    if (isSuper) {
        ...
        if (clsDeclaration.length) {
            ...
            convertJPDeclarationString(clsDeclaration);
        ...
        NSString *JPSelectorName =
        [NSString stringWithFormat:@"_ST%@", selectorName];
    ...
    if (instance) {
        ...
        if (!_JSMethodSignatureCache[cls]) {
            _JSMethodSignatureCache[(id<NSCopying>)cls] =
        ...
        [_JSMethodSignatureLock unlock];
        if (!methodSignature) {
            NSCAssert(methodSignature, @"unrecognized selector %@ for instance %@",
                      selectorName, instance);
            return nil;
        }
        ...
        if (!methodSignature) {
            NSCAssert(methodSignature, @"unrecognized selector %@ for class %@",
    ...
    if (inputArguments > numberOfArguments - 2) {
        // calling variable argument method, only support parameter type `id` and
        // return type `id`
        id sender = instance != nil ? instance : cls;
        id result = invokeVariableParameterMethod(argumentsObj, methodSignature,
                                                  sender, selector);
...
break;                                                          \
            ...
            case '*':
            case '^': {
                if ([valObj isKindOfClass:[STJPBoxing class]]) {
                    void *value = [((STJPBoxing *)valObj)unboxPointer];
            ...
            case '#': {
                if ([valObj isKindOfClass:[STJPBoxing class]]) {
                    Class value = [((STJPBoxing *)valObj)unboxClass];
                    [invocation setArgument:&value atIndex:i];
                    break;
                }
            }
            default: {
                ...
                if (valObj == _nilObj ||
                    ([valObj isKindOfClass:[NSNumber class]] &&
                     strcmp([valObj objCType], "c") == 0 && ![valObj boolValue])) {
                        valObj = nil;
                        [invocation setArgument:&valObj atIndex:i];
                        break;
                    }
    ...
    if ([_markArray count] > 0) {
        for (STJPBoxing *box in _markArray) {
            ...
            if (obj) {
                @synchronized(_TMPMemoryPool) {
                    [_TMPMemoryPool
                     setObject:obj
                     forKey:[NSNumber numberWithInteger:[(NSObject *)obj hash]]];
                }
            }
        }
    }
...
return [JSValue _methodName:result inContext:_context];         \
                ...
                case '^': {
                    void *result;
                    [invocation getReturnValue:&result];
                    returnValue = formatOCToJS([STJPBoxing boxPointer:result]);
                    break;
                }
                case '#': {
                    Class result;
                    [invocation getReturnValue:&result];
                    returnValue = formatOCToJS([STJPBoxing boxClass:result]);
                    break;
                }
            }
            return returnValue;
...
id (*st_new_msgSend1)(id, SEL, id,
                      ...) = (id (*)(id, SEL, id, ...))objc_msgSend;
id (*st_new_msgSend2)(id, SEL, id, id,
                      ...) = (id (*)(id, SEL, id, id, ...))objc_msgSend;
id (*st_new_msgSend3)(id, SEL, id, id, id,
                      ...) = (id (*)(id, SEL, id, id, id, ...))objc_msgSend;
id (*st_new_msgSend4)(id, SEL, id, id, id, id,
                      ...) = (id (*)(id, SEL, id, id, id, id, ...))objc_msgSend;
id (*st_new_msgSend5)(id, SEL, id, id, id, id, id,
                      ...) = (id (*)(id, SEL, id, id, id, id, id,
                                     ...))objc_msgSend;
id (*st_new_msgSend6)(id, SEL, id, id, id, id, id, id,
                      ...) = (id (*)(id, SEL, id, id, id, id, id, id,
                                     ...))objc_msgSend;
id (*st_new_msgSend7)(id, SEL, id, id, id, id, id, id, id,
                      ...) = (id (*)(id, SEL, id, id, id, id, id, id, id,
                                     ...))objc_msgSend;
id (*st_new_msgSend8)(id, SEL, id, id, id, id, id, id, id, id,
                      ...) = (id (*)(id, SEL, id, id, id, id, id, id, id, id,
                                     ...))objc_msgSend;
id (*st_new_msgSend9)(id, SEL, id, id, id, id, id, id, id, id, id,
                      ...) = (id (*)(id, SEL, id, id, id, id, id, id, id, id,
                                     id, ...))objc_msgSend;
id (*st_new_msgSend10)(id, SEL, id, id, id, id, id, id, id, id, id, id,
                       ...) = (id (*)(id, SEL, id, id, id, id, id, id, id, id,
                                      id, id, ...))objc_msgSend;

static id invokeVariableParameterMethod(NSMutableArray *origArgumentsList,
                                        NSMethodSignature *methodSignature,
    ...
    for (NSUInteger j = 0; j < inputArguments; j++) {
        ...
        argumentType[0] == 'r' ? argumentType[1] : argumentType[0];
        if (argumentTypeChar == '@') {
...
#define JP_CALL_MSGSEND_ARG1(_num) \
results = st_new_msgSend##_num(sender, selector, JP_G_ARG(0));
#define JP_CALL_MSGSEND_ARG2(_num) \
results = st_new_msgSend##_num(sender, selector, JP_G_ARG(0), JP_G_ARG(1));
#define JP_CALL_MSGSEND_ARG3(_num)                                           \
results = st_new_msgSend##_num(sender, selector, JP_G_ARG(0), JP_G_ARG(1), \
JP_G_ARG(2));
#define JP_CALL_MSGSEND_ARG4(_num)                                           \
results = st_new_msgSend##_num(sender, selector, JP_G_ARG(0), JP_G_ARG(1), \
JP_G_ARG(2), JP_G_ARG(3));
#define JP_CALL_MSGSEND_ARG5(_num)                                           \
results = st_new_msgSend##_num(sender, selector, JP_G_ARG(0), JP_G_ARG(1), \
JP_G_ARG(2), JP_G_ARG(3), JP_G_ARG(4));
#define JP_CALL_MSGSEND_ARG6(_num)                                           \
results = st_new_msgSend##_num(sender, selector, JP_G_ARG(0), JP_G_ARG(1), \
JP_G_ARG(2), JP_G_ARG(3), JP_G_ARG(4),      \
JP_G_ARG(5));
#define JP_CALL_MSGSEND_ARG7(_num)                                           \
results = st_new_msgSend##_num(sender, selector, JP_G_ARG(0), JP_G_ARG(1), \
JP_G_ARG(2), JP_G_ARG(3), JP_G_ARG(4),      \
JP_G_ARG(5), JP_G_ARG(6));
#define JP_CALL_MSGSEND_ARG8(_num)                                           \
results = st_new_msgSend##_num(sender, selector, JP_G_ARG(0), JP_G_ARG(1), \
JP_G_ARG(2), JP_G_ARG(3), JP_G_ARG(4),      \
JP_G_ARG(5), JP_G_ARG(6), JP_G_ARG(7));
#define JP_CALL_MSGSEND_ARG9(_num)                                          \
results = st_new_msgSend##_num(                                           \
sender, selector, JP_G_ARG(0), JP_G_ARG(1), JP_G_ARG(2), JP_G_ARG(3), \
JP_G_ARG(4), JP_G_ARG(5), JP_G_ARG(6), JP_G_ARG(7), JP_G_ARG(8));
#define JP_CALL_MSGSEND_ARG10(_num)                                          \
results = st_new_msgSend##_num(sender, selector, JP_G_ARG(0), JP_G_ARG(1), \
JP_G_ARG(2), JP_G_ARG(3), JP_G_ARG(4),      \
JP_G_ARG(5), JP_G_ARG(6), JP_G_ARG(7),      \
JP_G_ARG(8), JP_G_ARG(9));
#define JP_CALL_MSGSEND_ARG11(_num)                                          \
results = st_new_msgSend##_num(sender, selector, JP_G_ARG(0), JP_G_ARG(1), \
JP_G_ARG(2), JP_G_ARG(3), JP_G_ARG(4),      \
JP_G_ARG(5), JP_G_ARG(6), JP_G_ARG(7),      \
JP_G_ARG(8), JP_G_ARG(9), JP_G_ARG(10));
...
JP_CALL_MSGSEND_ARG##_realArgCount(_defineArgCount) \
    ...
    JP_IF_REAL_ARG_COUNT(3) {
        JP_DEAL_MSGSEND(3, 1) JP_DEAL_MSGSEND(3, 2) JP_DEAL_MSGSEND(3, 3)
    }
    JP_IF_REAL_ARG_COUNT(4) {
        JP_DEAL_MSGSEND(4, 1) JP_DEAL_MSGSEND(4, 2) JP_DEAL_MSGSEND(4, 3)
        JP_DEAL_MSGSEND(4, 4)
    }
    JP_IF_REAL_ARG_COUNT(5) {
        JP_DEAL_MSGSEND(5, 1) JP_DEAL_MSGSEND(5, 2) JP_DEAL_MSGSEND(5, 3)
        JP_DEAL_MSGSEND(5, 4) JP_DEAL_MSGSEND(5, 5)
    }
    JP_IF_REAL_ARG_COUNT(6) {
        JP_DEAL_MSGSEND(6, 1) JP_DEAL_MSGSEND(6, 2) JP_DEAL_MSGSEND(6, 3)
        JP_DEAL_MSGSEND(6, 4) JP_DEAL_MSGSEND(6, 5) JP_DEAL_MSGSEND(6, 6)
    }
    JP_IF_REAL_ARG_COUNT(7) {
        JP_DEAL_MSGSEND(7, 1) JP_DEAL_MSGSEND(7, 2) JP_DEAL_MSGSEND(7, 3)
        JP_DEAL_MSGSEND(7, 4) JP_DEAL_MSGSEND(7, 5) JP_DEAL_MSGSEND(7, 6)
        JP_DEAL_MSGSEND(7, 7)
    }
    JP_IF_REAL_ARG_COUNT(8) {
        JP_DEAL_MSGSEND(8, 1) JP_DEAL_MSGSEND(8, 2) JP_DEAL_MSGSEND(8, 3)
        JP_DEAL_MSGSEND(8, 4) JP_DEAL_MSGSEND(8, 5) JP_DEAL_MSGSEND(8, 6)
        JP_DEAL_MSGSEND(8, 7) JP_DEAL_MSGSEND(8, 8)
    }
    JP_IF_REAL_ARG_COUNT(9) {
        JP_DEAL_MSGSEND(9, 1) JP_DEAL_MSGSEND(9, 2) JP_DEAL_MSGSEND(9, 3)
        JP_DEAL_MSGSEND(9, 4) JP_DEAL_MSGSEND(9, 5) JP_DEAL_MSGSEND(9, 6)
        JP_DEAL_MSGSEND(9, 7) JP_DEAL_MSGSEND(9, 8) JP_DEAL_MSGSEND(9, 9)
    }
    JP_IF_REAL_ARG_COUNT(10) {
        JP_DEAL_MSGSEND(10, 1) JP_DEAL_MSGSEND(10, 2) JP_DEAL_MSGSEND(10, 3)
        JP_DEAL_MSGSEND(10, 4) JP_DEAL_MSGSEND(10, 5) JP_DEAL_MSGSEND(10, 6)
        JP_DEAL_MSGSEND(10, 7) JP_DEAL_MSGSEND(10, 8) JP_DEAL_MSGSEND(10, 9)
        JP_DEAL_MSGSEND(10, 10)
    }
...
[list addObject:formatOCToJS([NSNumber                           \
numberWithLongLong:(long long)_paramName])]; \
}                                                                  \
}
    
    NSArray *argTypes =
    [[jsVal[@"args"] toString] componentsSeparatedByString:@","];
...
static void getStructDataWithDict(void *structData, NSDictionary *dict,
                                  NSDictionary *structDefine) {
    NSArray *itemKeys = structDefine[@"keys"];
    const char *structTypes =
    [structDefine[@"types"] cStringUsingEncoding:NSUTF8StringEncoding];
    int position = 0;
...
break;                                                 \
            ...
            case '^': {
                ...
                void *val = [(STJPBoxing *)dict[itemKeys[i]] unboxPointer];
                memcpy(structData + position, &val, size);
                break;
            }
        }
...
static NSDictionary *getDictOfStruct(void *structData,
                                     NSDictionary *structDefine) {
...
break;                                       \
            ...
            case '^': {
                ...
                memcpy(val, structData + position, size);
                [dict setObject:[STJPBoxing boxPointer:val] forKey:itemKeys[i]];
                position += size;
                break;
            }
        }
...
static BOOL blockTypeIsObject(NSString *typeString) {
    return [typeString rangeOfString:@"*"].location != NSNotFound ||
    [typeString isEqualToString:@"id"];
}
...
static NSString *convertJPSelectorString(NSString *selectorString) {
    ...
    [tmpJSMethodName stringByReplacingOccurrencesOfString:@"_"
                                               withString:@":"];
    return
    [selectorName stringByReplacingOccurrencesOfString:@"-" withString:@"_"];
}
...
static id formatOCToJS(id obj) {
    if ([obj isKindOfClass:[NSString class]] ||
        ...
        return _wrapObj([STJPBoxing boxObj:obj]);
    }
...
static id formatJSToOC(JSValue *jsval) {
    ...
    if ([obj isKindOfClass:[STJPBoxing class]]) return [obj unbox];
    ...
    if ([obj isKindOfClass:[NSDictionary class]]) {
        if (obj[@"__obj"]) {
            ...
            if ([ocObj isKindOfClass:[STJPBoxing class]]) return [ocObj unbox];
            return ocObj;
        }
        if (obj[@"__isBlock"]) {
...
+ (void *)formatPointerJSToOC:(JSValue *)val {
    id obj = [val toObject];
    if ([obj isKindOfClass:[NSDictionary class]]) {
        if (obj[@"__obj"] && [obj[@"__obj"] isKindOfClass:[STJPBoxing class]]) {
            return [(STJPBoxing *)(obj[@"__obj"])unboxPointer];
        } else {
            return NULL;
        }
    } else if (![val toBool]) {
        ...
        return [((STJPBoxing *)[val toObject])unboxPointer];
    }
}

+ (id)formatRetainedCFTypeOCToJS:(CFTypeRef)CF_CONSUMED type {
    return formatOCToJS([STJPBoxing boxPointer:(void *)type]);
}

+ (id)formatPointerOCToJS:(void *)pointer {
    return formatOCToJS([STJPBoxing boxPointer:pointer]);
}
...
+ (void)getStructDataWidthDict:(void *)structData
                          dict:(NSDictionary *)dict
                  structDefine:(NSDictionary *)structDefine {
    return getStructDataWithDict(structData, dict, structDefine);
}

+ (NSDictionary *)getDictOfStruct:(void *)structData
                     structDefine:(NSDictionary *)structDefine {
