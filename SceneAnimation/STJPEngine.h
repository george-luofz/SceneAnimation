...
/*!
 @method
 @description Evaluate Javascript code from a file Path. Call it after
 +startEngine.
...
/*!
 ...
 The method will generate a default resouceURL named "main.js" to the Safari
 debugger.
...
@interface STJPExtension : NSObject
